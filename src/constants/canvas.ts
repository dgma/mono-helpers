export const CANVAS_ADDRESS = "0xB23AF8707c442f59BDfC368612Bd8DbCca8a7a5a";

export const CANVAS_ABI = [
  { inputs: [], stateMutability: "nonpayable", type: "constructor" },
  { inputs: [], name: "CallerIsNotUserProfile", type: "error" },
  { inputs: [], name: "DuplicatedUsername", type: "error" },
  { inputs: [], name: "ExpiredSignature", type: "error" },
  { inputs: [], name: "ImplementationNotContract", type: "error" },
  { inputs: [], name: "InvalidReferrer", type: "error" },
  { inputs: [], name: "InvalidSignature", type: "error" },
  { inputs: [], name: "InvalidUsername", type: "error" },
  { inputs: [], name: "MsgValueMismatchWithMintFee", type: "error" },
  { inputs: [], name: "ProfileAlreadyMinted", type: "error" },
  ...
  },
  {
    ...
    name: "UnregisterUsername",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "string", name: "oldAvatar", type: "string" },
      { indexed: false, internalType: "string", name: "newAvatar", type: "string" },
    ],
    name: "UpdateDefaultProfileAvatar",
    type: "event",
  },
  {
    anonymous: false,
    ...
    name: "UpdateProfileImplementation",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "profileImpl_", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    name: "referrerData",
    outputs: [
      { internalType: "uint128", name: "referred", type: "uint128" },
      { internalType: "uint128", name: "earned", type: "uint128" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "string", name: "newAvatar", type: "string" }],
    name: "updateDefaultProfileAvatar",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
